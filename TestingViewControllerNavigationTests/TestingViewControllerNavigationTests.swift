...
final class TestingViewControllerNavigationTests: XCTestCase {
    ...
    func test_NextViewButton_WhenTapped_SecondViewControllerIsPushed_AnotherApproach() {
        sut.nextViewButton.sendActions(for: .touchUpInside)
    ...
    func test_NextViewButton_WhenTapped_SecondViewControllerIsPushed_AnotherApproach_SPY() {
